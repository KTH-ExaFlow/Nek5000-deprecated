...
#error "sc_fwrap.h requires nekp4est.h"
#endif
 ...
 * @param len_f
 */
#ifdef LEN_FOLLOW_STRING
void fsc_pkg_reg(int * package_id, int * log_threshold,
		 char * name, int len_n,char * full, int len_f);
#else
void fsc_pkg_reg(int * package_id,int * log_threshold,
		 char * name,char * full, int len_n, int len_f);
#endif
